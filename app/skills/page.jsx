...
import { FaHtml5, FaCss3Alt, FaJsSquare, FaReact, FaNodeJs, FaDatabase, FaGitAlt, FaPython, FaJava, FaCuttlefish, FaLaptopCode, FaGlobe, FaBrain } from "react-icons/fa";
import { SiNextdotjs, SiTypescript, SiExpress, SiPostman, SiCplusplus, SiTailwindcss, SiMongodb } from "react-icons/si";
            ...
            >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {group.skills.map((skill, index) => (
                  <div
                    key={index}
                    className="group flex flex-col items-center justify-center gap-3 bg-gray-800/40 p-5 rounded-2xl border border-white/5 hover:border-blue-500/50 hover:bg-blue-500/10 transition-all duration-300"
                  >
